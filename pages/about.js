        ...
        <div className="flex flex-wrap justify-between  mx-[5%] md:mx-[10%] lg:ml-[20%]  lg:mr-[15%]  ">
          <div>
           ...
           text-[15px] md:text-[17px]  w-[380px]  relative z-40  md:w-[550px]  "
            >
              Hello! My name is Merzouk Ilyes Reda i&apos;m a software engineer
              from Algeria, My interest in web development started back in 2018
              when i created my first website and since then i kept exploring
              the vast world of web development and specifically the software
              development lifecycle including analysis, development, testing and
              deployment. currently I&apos;m interested in DevOps, testing & AI.
              <br />
              <br />
              <span>
                {" "}
